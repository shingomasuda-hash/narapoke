  ...
  return (
    <main className="space-y-6">
      ...
      <div className="space-y-3">
        <Link href="/reserve?mode=morning" className="btn-primary whitespace-nowrap" aria-label="モーニングを予約する">
          ☀️ モーニングを予約する<span className="text-sm font-semibold">（9:00〜11:00）</span>
        </Link>
      ...
      <section className="card space-y-2 text-sm text-sumi">
        ...
        {isThu ? (
          ...
          <>
            <p>モーニング 9:00〜11:00 ／ ランチ 11:00〜16:00 ／ ディナー 18:00〜24:00</p>
